...
function MainAppLayout() {
  ...
  // LOGICA RIVISTA PER ESSERE ANCORA PIÙ ESPLICITA
  const actionConfig: ActionConfig = useMemo(() => {
    // Se siamo sulla pagina della musica, la sua logica ha la priorità assoluta.
    ...
    // Per tutte le altre pagine, usiamo la logica standard.
    switch (currentPath) {
      case '/':
        return { icon: Dumbbell, onClick: registeredAction, label: 'Registra Set', disabled: !registeredAction };
      case '/manage':
        return { icon: Plus, onClick: registeredAction, label: 'Crea Scheda', disabled: !registeredagisteredAction };
      case '/stats':
